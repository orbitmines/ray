...
subtableParsers[1] = function parseLookup1() {
    ...
    const substFormat = this.u16();
    if (substFormat === 1) {
        return {
            substFormat: 1,
            coverage: this.parsePointer(Parser.coverage),
            deltaGlyphId: this.i16()
        };
    } else if (substFormat === 2) {
        return {
            substFormat: 2,
            coverage: this.parsePointer(Parser.coverage),
            substitute: this.parseUShortList()
        };
    }
...
subtableParsers[4] = function parseLookup4() {
    ...
    return {
        ...
        ligatureSets: this.parseListOfLists(function() {
            return {
                ligGlyph: this.u16(),
                components: this.parseUShortList(this.u16() - 1)
            };
        })
    };
};
        ...
        return {
            ...
            chainRuleSets: this.parseListOfLists(function() {
                return {
                    ...
                    input: this.parseUShortList(this.i16() - 1),
...
subtableParsers[7] = function parseLookup7() {
    ...
    const extensionLookupType = this.u16();
    const extensionParser = new Parser(this.data, this.offset + this.u32());
    return {
        substFormat: 1,
