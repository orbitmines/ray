...
subtableParsers[2] = function parseLookup2() {
    ...
    const valueFormat1 = this.u16();
    const valueFormat2 = this.u16();
    if (posFormat === 1) {
        ...
        const class1Count = this.u16();
        const class2Count = this.u16();
        return {
