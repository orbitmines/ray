...
//        )
      ...
      Rule(
        ...
        pattern = Regex("""\b(?:this|static|enum|bidirectional|equivalent|initializer|right-to-left|global|local|super|sub|secure|persistent|equivalent|equivalence|class|namespace|dynamically|external|internal|none|confidential|managed|assert|read|write|execute)\b""")
      ),
