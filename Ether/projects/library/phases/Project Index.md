...
MLIR dialects: Affine, SCF, Tensor, Standard, LLVM, XLA, etc.
...
1lab, ACL2, Agda, Agda -> Dedukti (Agda2Dedukti), Agda -> UniMath, Alethe proof checking, ALEXANDRIA Project, ALF, Amulet (programming language), Android Studio, Andromeda, Anoma, Apache TVM, Applied Category Theory, Arend, BabylonJS (Rendering engine), Backus-Naur Form (BNF), Bazel, Bigraph, BIOS, Boyer-Moore Theorem Prover (NQTHM), B-pog -> Lambdapi, CADE ATP System Competition (CASC), Calculus, Calculus of communicating systems (CCS), Calculus of Constructions, Cartesian product, Categorica, Certified Programs and Proofs (CPP), Certora Prover, Cohomology, Coinduction, Combinators, Constructor Theory, Controlled Natural Language (CNL), Coq, Coq -> Dedukti (CoqInE), Coq -> Homotopy Type Theory (HoTT), Coq -> UniMath, Coq -> UniMath -> Type Theory, Crossed Dragone, Cubical Type Theory, CUDA, Cyc, Dawn, Dedukti, Dedukti -> others (STTfaXport), Dependent Type Theory, Docker, Double pushout graph rewriting (DPO), Elm, Emacs, Epigram, E (Theorem Prover), EuroProofNet, F*, Flyspeck project, Formal Abstracts (FAbstracts), Formalisation of Constructive Univalent Type Theory (ForCUTT), ForMath Project, Foundations of Mathematics (FOM), Fredkin gate, Frobenius algebra, games-and-generation, Genaille-Lucas rulers, General-purpose computing on graphics processing units (GPGPU), Generic Symmetric Monoidal Category, GIt, Glasgow Haskell Compiler (GHC), Glencoe, GrapeVine, Graph Percolation Theory, Group Explorer, Haskell, Haskell -> Agda, Higher Category Theory, HigherOrderCO, Higher Order Logic (HOL), HOL -> Dedukti (Holide), HOL Light, HOL-Light -> Dedukti (hol2dk), Homotopy Type Theory Electronic Seminar Talks (HoTTEST), Homotopy Type Theory (HoTT), Hypergraph Category, HypergraphDB, Idris, Intelligible semi-automated reasoning (Isar), Intermediate Representation (IR), Interoperable and Confident Set-based Proof Assistants (ICSPA), IPFS, IPLD, IPVM, Isabelle, Isabelle Archive of Formal Proofs (AFP), Isabelle -> Dedukti, itex2MML, JavaScript, JPEG JPG PNG, JSON-LD, Julia (programming language), Knot Theory, Lambdapi, Langlands program, LaTeX, Lean, LEGO, Lie algebra, Lie Theory, LLVM, MakerJS, Many-sorted logic, Markdown, Mathematics Genealogy Project, MathJax, MathScheme, MathSciNet, Matryoshka Project, Mealy machines, Mesa 3D, Message passing, Metamath, MetiTarski, MIT Probabilistic Computing Project, Mizar System, ML (programming language), Modal Type Theory, Monoid, Monoidal Category Theory, Monoidal PROduct and Permutation Category (PROP), n-Category Cafe, Nekoka, networking-and-security, nForum, NixOS, nLab, Node.js, Northeastern University Programming Research Lab (Nuprl), NuPRL, OCaml, OCaml -> Coq, OCaml Scientific Computing (OWL), OCaml -> Wasm SpecTec, OCaml -> WebAssembly, Open Computing Language (OpenCL), PDF, Petri net, platforms, Playcanvas (Rendering engine), Powerset construction (Rabin-Scott Theorem), Practal, Project Everest, Proofcraft, ProofPower, PVS -> Dedukti (Personoj), PVS (People's Verification System or Prototype Verification System?), Pyramid (image processing), PyZX, QFP, Qimaera, Qt, Quantomatic, Quaternion, React Native, react-native-webassembly, Research in Software Engineering (RiSE), reStructuredText, Retrocausality, Riak, Ring Theory, rosenbridge, Rust, Rzk, SageMath, sandsifter, schema.org, Search Engine by the Alexandria Project for ISabelle (SErAPIS), Search Engine Optimization (SEO), Set Theory, ShareJS, Simplicial Type Theory, Simultaneous Multithreading (SMT), Single pushout graph rewriting (SPO), SMT-LIB -> Dedukti (smt2d), SPASS, Special Commutative Frobenius Algebra (SCFA), Stardust, Statebox, Superposition calculus, Superscalar Processor, Symmetric closure, Symmetric Monoidal Theory (SMT), TeX, The QED Project, The Unicode Common Locale Data Repository (CLDR), Thousands of Problems for Theorem Provers (TPTP), ThreeJS, Tinygrad, Topology, Transcendental syntax, Treesitter, TSTP -> Dedukti (Ekstrakto), Twelf, typedefs, TypeScript, Type Theory, Unicode, UniMath, Univalence Axiom, Univalent Foundations, UTF-8, version-control, Virgil, VirtualBox, Vulkan, wasm3, Wasm4, Wasm SpecTec, WebAssembly, WebAssembly System Interface (WASI), WebGL, WebGPU, WebGPU Shading Language (WGSL), WebXR, wgpu, Why3, Wireworld, Wizard Engine, Wolfram Language, X86, Yoneda lemma, Zenon -> Dedukti (Zenon Modulo), Zeta Calculus, ZX-Calculus
...
Pending
- [Infrageometry](https://github.com/WolframInstitute/Infrageometry) (& basically translate to usual hypergraphs), Polycomputation ([[Michael Levin]]), [Covariant computation](https://twitter.com/getjonwithit/status/1780722985747263709)
