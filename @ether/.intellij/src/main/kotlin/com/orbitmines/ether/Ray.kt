...
//        )
      ...
      Rule(
        ...
        pattern = Regex("""\b(?:this|static|enum|bidirectional|equivalent|modifier|initializer|right-to-left|global|local|super|sub|secure|persistent|equivalent|equivalence|class|namespace|dynamically|external|internal|none|confidential|managed|assert|read|write|execute)\b""")
      ),
      ...
      Rule(
        ...
        pattern = Regex("""\b(?:not|while|break|choose|goto|trivially|branch|unless|if|elsif|then|else|recur|return|theorem|not|in|assume|boolean|Number|String)\b""")
      ),
