...
function parseHeadTable(data, start) {
    ...
    head.checkSumAdjustment = p.u32();
    head.magicNumber = p.u32();
    check.argument(head.magicNumber === 0x5F0F3CF5, 'Font header has wrong magic number.');
    head.flags = p.u16();
    head.unitsPerEm = p.u16();
    ...
    head.yMax = p.i16();
    head.macStyle = p.u16();
    head.lowestRecPPEM = p.u16();
    head.fontDirectionHint = p.i16();
    head.indexToLocFormat = p.i16();
    head.glyphDataFormat = p.i16();
    return head;
}
