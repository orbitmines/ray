...
//        )
      ...
      Rule(
        ...
        pattern = Regex("""\b(?:this|static|end|global|local|persistent|equivalent|equivalence|class|namespace|dynamically|external|internal|none|confidential|managed|assert|read|write|execute)\b""")
      ),
